...
// $Rev: 52393 $
// Datei am 19.04.2022 13:27:47 erzeugt aus der unten beschriebenen Typbibliothek.

// ************************************************************************  //
// Typbib.: C:\Windows\SysWOW64\PortableDeviceApi.dll (1)
// LIBID: {1F001332-1A57-4934-BE31-AFFC99F4EE0A}
// LCID: 0
// Hilfedatei: 
// Hilfe-String: PortableDeviceApi 1.0 Type Library
// Liste der Abhäng.: 
//   (1) v2.0 stdole, (C:\Windows\SysWOW64\stdole2.tlb)
// SYS_KIND: SYS_WIN32
// Fehler:
//   Hinweis: Symbol 'type' umbenannt in 'type_'
//   Hinweis: Parameter 'Property' im IPortableDeviceServiceCapabilities.GetFormatPropertyAttributes geändert zu 'Property_'
// ************************************************************************ //

// manual changes by J. Rathlev, April 2022
// removed:   _tagpropertykey record (using definition in Winapi.ActiveX)
// added:     function SHCreateStreamOnFileEx
//            IID_IPortableDevicePropertiesBulk
//            IID_IPortableDevicePropertiesBulkCallback
//            several CLSID definitions
// fixed:     IPortableDeviceManager (functions return WChar instead of Word)
...
// *********************************************************************//
  IPortableDevicePropertiesBulk = interface(IUnknown)
    ...
    function QueueSetValuesByObjectList(pObjectValues: IPortableDeviceValuesCollection;
                  pCallback: IPortableDevicePropertiesBulkCallback;
                  out pContext: TGuid): HResult; stdcall;
    function Start(var pContext: TGuid): HResult; stdcall;
    function Cancel(var pContext: TGuid): HResult; stdcall;
  end;
...
// *********************************************************************//
  IPortableDevicePropertiesBulkCallback = interface(IUnknown)
    ...
    function OnStart(var pContext: TGuid): HResult; stdcall;
    function OnProgress(var pContext: TGuid; pResults: IPortableDeviceValuesCollection): HResult; stdcall;
    function OnEnd(var pContext: TGuid; hrStatus: HResult): HResult; stdcall;
  end;
